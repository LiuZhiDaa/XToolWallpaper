...
import app.xtoolwallpaper.com.myapplication.base.bean.ResultCallback;
...
public class OkHttpEngine {
     ...
     * @param callback
     */
    public void postAsynHttp(String url, RequestBody requestBody,ResultCallback callback) {
